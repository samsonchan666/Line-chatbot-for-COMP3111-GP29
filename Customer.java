...
public class Fee{
	...
	public void setTotalFee() { this.total_fee = getAdultFee()+getChildrenFee()+getToodlerFee();}
	public double getTotalFee()  {return total_fee;}
	
	public void setAdultFee(int fee) { this.adult_fee += fee;}
	public double getAdultFee() { return adult_fee;}
	
	public void setChildrenFee(int fee) { this.children_fee += fee/2;}
	public double getChildrenFee() { return children_fee;}
	
	public void setToodlerFee(int fee) { this.toodler_fee += fee/2;}
	public double getToodlerFee() { return toodler_fee;}
}